...
const platformFeatures = [
  ...
  },
  {
    ...
    copy: 'Senales de forma, tabla y contexto para entrar al partido con criterio real.',
  },
  {
    icon: MessageSquare,
    title: 'Seguimiento de clubes',
    copy: 'Informacion de equipos, plantillas y jornadas en un mismo flujo premium.',
  },
  {
    icon: ShieldCheck,
    title: 'Club universe',
          ...
          <div className="football-container football-hero-layout">
            ...
            <div className="football-hero-visual" data-hero-item>
              ...
              <article className="hero-scoreboard hero-scoreboard-side hero-scoreboard-side-bottom" data-tilt>
                <span className="scoreboard-label">Datos</span>
                <strong>92%</strong>
                <p>Tendencias y rendimiento renderizados para lectura inmediata.</p>
              </article>
            </div>
          </div>
        </section>
