---
name: "colorful-design-system"
description: "Colorful Design System design system for AI coding agents."
metadata:
  author: typeui.sh
...
## Style
A bold, playful, candy-colored interface inspired by retro snack branding — warm cream backgrounds, hard offset shadows, chunky rounded shapes, and the "Luckiest Guy" display font create a fun, energetic, neo-brutalist aesthetic with a green (#1F7B45) brand accent
