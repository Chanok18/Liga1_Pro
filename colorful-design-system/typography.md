...
- **Heading font:** "Luckiest Guy", cursive — configured at app level via Google Fonts import
- **Body font:** Inter, sans-serif — configured at app level, never override
- **Headings:** normal weight (400), heading text color, uppercase
